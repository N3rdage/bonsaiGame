...
4. **[Math] Why the wired branch still looks straight** — `branch.bend` rotates the direction vector but the branch geometry stays a straight line. Sets up the Frenet-frame / parallel-transport TODO (currently #11, #12 in TODO.md). Calculus-curious readers welcome.
